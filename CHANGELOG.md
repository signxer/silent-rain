...
## 1.7.6
- feat(ui): 仪表盘趋势图+本次已学、欢迎页(首启交错入场)、页面淡入、进度环平滑动画；chore: VERSION 1.7.6
- feat(ui): 日志按类型着色/worker状态着色(绿成功红失败蓝进行中)、学时数值着色、进度环完成变绿、模式切换确认防误清、表格标题成功失败汇总
- chore: VERSION 1.7.5
- docs: CHANGELOG 1.7.5
# 更新日志
